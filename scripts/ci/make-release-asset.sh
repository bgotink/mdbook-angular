...
case $1 in
  ...
  *macos*)
    ...
    ;;
  windows*)
    asset="mdbook-angular-$TAG-$target.zip"
    7z a ../../$asset mdbook-angular.exe
    ;;
  *)
...
then
  ...
  echo "MDBOOK_ANGULAR_TAG=$TAG" >> $GITHUB_ENV
  echo "MDBOOK_ANGULAR_ASSET=target/$asset" >> $GITHUB_ENV
fi
